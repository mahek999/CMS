...
// REGISTER USER
  ...
  if (count($errors) == 0) {
    $query = "INSERT INTO teacher (semester, batch, question, video, topic, date1) 
              VALUES('$semester', '$batch', '$question', '$video' ,'$topic', '$date1')";
...
<label>Batch</label>
<input class="form-control" name="batch" id="fieldEmail" type="text" placeholder="batch(B1,B2,etc)" required=""  data-namelabel="batch">
</div>
<div class="form-group fieldEmail-container ">
<label>Announcement</label>
<input class="form-control"name="question" id="fieldEmail" type="text" placeholder="Announcement" data-namelabel="question">
</div>
<div class="form-group fieldEmail-container ">
...
<div class="form-group fieldEmail-container ">
<label>Date Of video/Announcement</label>
<input class="form-control"name="date" id="fieldEmail" type="text" placeholder="Date of video/Announcement(dd-mm-yy)" required="" data-namelabel="video">
</div>
