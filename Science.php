...
// REGISTER USER
   ...
   $sql_query3="select question as q from teacher where semester ='".$s1[0]."' and batch='".$s4[0]."'";
          	$result3 = mysqli_query($link,$sql_query3);
			$s3 = mysqli_fetch_array($result3);
	       
	 $sql_query7="SELECT count(*) as cntUser FROM teacher WHERE semester ='".$s1[0]."' and batch='".$s4[0]."'";
...
<meta http-equiv="content-language" content="en"><title>DSCE-Announcement</title>
...
<li><a href="./Science.php" data-uri-path="/science-" target="_self">Announcement</a></li>
<li><a href="./" data-uri-path="/" target="_self">LogOut</a></li>
</ul>
...
<h2 class="section-title title section-title--md" data-type="text"></t></t>DSCE-Announcement<span data-prop="title" class="ck-editable-element" data-editable="basic" style="display:none;"></span></h2>
<p class="section-description body--md" data-type="text"><?php if($count>0){echo $s3[0];}
else
{
echo "no new announcement is there";}?><span data-prop="description" class="ck-editable-element" data-editable="basic" style="display:none;"></span></p>
</div>
</div>
</div>
</div>
...
<div class="buttons">
<a class="opaque body--sm" href="tel:6396066753" data-type="phone">6396066753</a>
<br>
<a class="opaque body--sm" href="mailto:dsce@gmail.com" data-type="email">dsce@gmail.com</a>
</div>
</div>
</div>
<div class="col-small">
...
<li>
<a href="./Science.php" data-uri-path="/science-" class="opaque body-text body--sm ">Announcement</a>
</li>
<li>
